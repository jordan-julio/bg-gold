...
const products: Product[] = [
  ...
  { name: 'Rose Gold Ring',  gltfPath: '/models/a.glb' },
  { name: 'White Gold Ring', gltfPath: '/models/a.glb' },
  { name: 'Titanium Ring',   gltfPath: '/models/a.glb' },
  { name: 'Copper Ring',     gltfPath: '/models/a.glb' },
  { name: 'Tungsten Ring',   gltfPath: '/models/a.glb' },
  { name: 'Silver Ring',     gltfPath: '/models/a.glb' },
  { name: 'Rose Gold Ring',  gltfPath: '/models/a.glb' },
  { name: 'White Gold Ring', gltfPath: '/models/a.glb' },
  { name: 'Titanium Ring',   gltfPath: '/models/a.glb' },
  { name: 'Copper Ring',     gltfPath: '/models/a.glb' },
